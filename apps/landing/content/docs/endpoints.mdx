...
Analytics chart screenshots are served from `/assets/graphs/*` (mapped from `apps/landing/public/assets/graphs`).
...
![Interface snapshot showing API-driven assistant and analytics integration in the landing product](/landing/api.jpg)
![Result analysis snapshot showing student outcome visualization in the Singularity experience](/landing/miet-results.png)
