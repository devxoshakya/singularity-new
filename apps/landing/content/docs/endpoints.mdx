...
![Student status distribution analytics chart](/assets/graphs/1.png)
![Branch status breakdown analytics chart](/assets/graphs/2.png)
![Year and branch comparison analytics chart](/assets/graphs/3.png)
![Two-year performance metrics analytics chart](/assets/graphs/4.png)
![Semester progression analytics chart](/assets/graphs/5.png)
![Backlog and branch radar analytics chart](/assets/graphs/6.png)
![Top performer and SGPA range analytics chart](/assets/graphs/7.png)
