...
![Landing hero visual showing the Singularity brand and institutional AI product identity](/landing/Sentra.png)
![Product visual highlighting API and intelligence-driven assistant capabilities](/landing/api.jpg)
![Result interface visual showing MIET student performance and analysis output](/landing/miet-results.png)
![Desktop dashboard visual showing the primary workspace layout and interactions](/landing/desktop.png)
