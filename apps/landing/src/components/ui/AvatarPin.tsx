            ...
            >
                {clerkAvatarSrc ? (
                    <Image
                        ...
                        alt="avatar"
                        height={80}
                        className="h-20 w-20 object-cover dark:shadow-[inset_-5px_-18px_38px_22px_#000000]"
                        width={80}
                    />
                ) : (
                    <div className="flex h-20 w-20 items-center justify-center bg-muted text-lg font-semibold text-foreground">
                        {fallbackInitial}
                    </div>
                )}
            </motion.div>
