...
export function Footer() {
  return (
    <footer className="w-full h-80 border rounded-2xl overflow-hidden relative">
      <img
        src="https://cdn2.devxoshakya.xyz/landing/FractalMaze.jpg"
        alt="Fractal background"
        className="absolute inset-0 w-full h-full opacity-40 blur-[1px] md:blur-[2px] object-cover rotate-180"
      />

      <div className="absolute right-40 xl:flex hidden top-30 items-center justify-center size-32 border-2 border-white/30 p-6 rounded-4xl bg-accent/10 backdrop-blur-xs">
