...
export function AuthPage() {
    ...
    return (
        <main className="relative md:h-screen md:overflow-hidden lg:grid lg:grid-cols-2">
                ...
                <div className="z-10 mt-auto">
                    <blockquote className="space-y-2">
                        <p className="text-xl">
                            ...
                            verify student's background faster than ever
                            before.&rdquo;
                        </p>
            ...
            <div className="relative bg-[#000000A0] flex min-h-screen flex-col justify-center p-4">
                <div
                    aria-hidden
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg py-1.5 px-2 text-center">
                            <p className="text-sm text-blue-600 dark:text-blue-400 flex items-center justify-center gap-2">
                                ...
                                <span>
                                    Use your MIET official email ID
                                    (@miet.ac.in) to login
                                </span>
                            </p>
                        </div>
