/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 9d4e5716537f40f6e94a8d9fddcaa61a)
// Runtime types generated with workerd@1.20260317.1 2025-06-15 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		DODO_PRO_PLAN_HALF_YEARLY_PRICE_ID: string;
		DODO_PRO_PLAN_YEARLY_PRICE_ID: string;
		DODO_PREMIUM_PLAN_HALF_YEARLY_PRICE_ID: string;
		DODO_PREMIUM_PLAN_YEARLY_PRICE_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DATABASE_URL" | "DIRECT_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "CORS_ORIGIN" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "FRONTEND_URL" | "DODO_PAYMENTS_API_KEY" | "DODO_PAYMENTS_WEBHOOK_SECRET" | "DODO_PRO_PLAN_HALF_YEARLY_PRICE_ID" | "DODO_PRO_PLAN_YEARLY_PRICE_ID" | "DODO_PREMIUM_PLAN_HALF_YEARLY_PRICE_ID" | "DODO_PREMIUM_PLAN_YEARLY_PRICE_ID" | "WORKER_ENVIRONMENT">> {}
}
